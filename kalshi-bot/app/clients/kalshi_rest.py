...
class KalshiRESTClient:
    """Async REST client with signed requests and cursor pagination."""
    ...
    async def request(
        ...
        *,
        ...
        """Send request with bounded exponential backoff."""
        if max_attempts < 1:
    ...
    async def paginate(self, path: str, *, params: dict[str, Any] | None = None) -> list[dict[str, Any]]:
        """Fetch all cursor-paginated objects from list endpoints."""
...
__all__ = ["KalshiRESTClient", "KalshiRestClient"]
