...
class ExchangeHealth:
    ...
    def healthy_for_trading(self) -> bool:
        ...
        return self.exchange_open and not self.in_maintenance and normalized in {"open", "active"}
...
async def fetch_exchange_health(rest_client: KalshiRESTClient) -> ExchangeHealth:
    ...
    exchange_open = bool(status_payload.get("is_open", status.lower() in {"open", "active"}))
    in_maintenance = bool(
...
__all__ = ["ExchangeHealth", "fetch_exchange_health"]
